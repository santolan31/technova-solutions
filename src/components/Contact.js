            ...
            <div className="contact-details">
              <div className="contact-item">
                ...
                <div className="contact-item-content">
                  ...
                  <p>Nuestro equipo de soporte responderá en 24 horas.</p>
                  <a href="mailto:info@technovasolutions.com" className="contact-link">
              ...
              <div className="contact-item">
                ...
                <div className="contact-item-content">
                  <h3>Teléfono</h3>
                  <p>L-V de 9am a 6pm.</p>
                  <a href="tel:+573178219112" className="contact-link">
                    317 821 9112
                  </a>
                </div>
              </div>
